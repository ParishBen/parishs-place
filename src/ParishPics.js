...
const ParishPics = () => {
    return(
        <div style={{position:'relative', top:'20pt', textAlign:'center', backgroundColor:'darkgoldenrod'}}>
            ...
            <ul style={{listStyle: "none"}}><li><img src= "https://live.staticflickr.com/65535/51823489824_ca33c82976.jpg" width="500" height="480" alt="Rory Clause" title="Miss Rory Santa Clause" /></li></ul>
