const Blog0 = () => {
    ...
    return (
        ...
        {/* <div class="container-fluid" style={{backgroundColor:'lightseagreen', boxShadow: '0 0 20px black',textAlign:'center', paddingBottom: '10px', paddingLeft:'3pt' }}> */}
            <h2 style={{fontSize:'32px', fontWeight:'bolder', textDecoration:'underline',fontStyle:'italic'}}> How'd I get on this track?</h2>
        ...
        {(isNaN(window.location.pathname.split('/').slice(-1))) ? '' :
              <button id="next" style={{position:'fixed',left:'2pt'}} onClick={()=>window.location.pathname = "/blogs/2"}>Next Blog</button>}
